...
| **SQUID magnetometry** | [`squid.py`](src/checkmsg/squid.py) | Bulk magnetic ordering, Curie/Néel T, saturation moment, AC χ′(ω)/χ″(ω) — distinguishes magnetite vs hematite, freshwater vs saltwater pearls, HPHT vs natural diamond | 13 magnetic minerals (Dunlop & Özdemir 1997) |
